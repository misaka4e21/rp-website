...
def translate_category(category):
    mappings = {
        ...
        "Economy":          "Economía",
        "Health":           "Salud",
        "Science & Tech":   "Ciencia & Tecnología",
        "Arts & Music":     "Arte & Música",
        "Frontline":        "Guerra",
        "World":            "Mundo",
        "Video Reports":    "Reportajes en Vídeo",
        "In Pictures":      "En Imágenes",
        "Special Reports":  "Reportajes Especiales",
        "Explainers":       "Explicaciones",
        "Opinion":          "Opinión"
    }
...
<header role="page">
	...
	<p>Entérate de lo que pasa en el mundo revolucionario de Rojava.</p>
</header>
...
<div id="pagination">
	...
	<a href="%s" class="button older">Artículos anteriores »</a>
</div>
...
<header role="page">
    <h1>%s</h1>
	<p>Mostrando todos los elementos nuevos de la categoría "%s".</p>
</header>
...
<header role="page">
    <h1>%s</h1>
	<p>Mostrando todos los artículos nuevos del mes de %s.
    <a href="%s">Archivo entero »</a></p>
</header>
...
class Interface:
    ...
    def __init__(self):
        self.build_prefix = "/var/www/html/es/"
        self.data_prefix = "/"
        self.link_prefix = "/es/"
        ...
        self.params = {
            "title": "Lo que has estado esperando.",
...
categories = {
    ...
    "Economía":         "economia",
    "Salud":          "salud",
    "Ciencia & Tecnología":  "ciencia",
    "Arte & Música":    "arte",
    "Guerra":       "guerra",
    "Mundo":           "mundo",
    "Reportajes en Vídeo":   "video",
    "En Imágenes":     "imagenes",
    "Reportajes Especiales": "especial",
