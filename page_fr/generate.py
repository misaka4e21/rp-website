...
def generate_index_html(interface):
    ...
    for i in range(4):
        ...
        <article>
            ...
            <h1>%s</h1></a>
            <p>%s</p>
            <p class="meta"><time pubdate="">%s</time> / <a href="%s">Leer »</a></p>
        </article>
...
<article>
	...
	<div class="group">
        ...
        <p>%s</p>
		<p><a href="%s">Continuer à lire »</a></p>
    </div>

	<footer>
		<ul>
			<li class="date"><time datetime="2012-05-17T08:35-05:00" pubdate=""><span>%s</span> <em>%s</em></time></li>
			<li class="comments"><a target="_blank" href="%s">Commentaire</a></li>
			<li class="tags">
""" % (link, article["title"], article["preview"], article["blurb"], link,
    ...
    for category in article["categories"]:
        try:
            ...
            print >> sys.stderr, "************************************************"
            print >> sys.stderr, "Erreur: Catégorie non existante: %s" % category
            print >> sys.stderr, "************************************************"
            raise Exception("Catégorie non existante: %s" % category)
...
<header role="page">
	...
	<p>Découvrez ce qui se passe dans le monde révolutionnaire du Rojava.</p>
</header>
...
<div id="pagination">
	...
	<a href="%s" class="button older">Articles précédents »</a>
</div>
...
<header role="page">
    <h1>%s</h1>
	<p>Afficher tous les nouveaux articles de la catégorie "%s".</p>
</header>
...
<header role="page">
    <h1>%s</h1>
	<p>Afficher tous les nouveaux articles du mois %s.
    <a href="%s">Fichier entier »</a></p>
</header>
...
<header role="page">
	...
	<p>Todos los artículos que hemos publicado están aquí.</p>
</header>
...
class Interface:
    ...
    def __init__(self):
        self.build_prefix = "/var/www/html/fr/"
        self.data_prefix = "/"
        self.link_prefix = "/fr/"
        self.articles_prefix = "articles/"
        # Must end in a /
        assert self.link_prefix[-1] == "/", "Doit se terminer avec /"
        self.params = {
            "title": "Qu'est-ce que vous avez attendu.",
...
categories = {
    ...
    "Arts & Musique":    "arts",
    "Première Ligne":       "guerre",
    "Monde":           "monde",
    "Rapports Vidéo":   "video",
    "En Images":     "images",
    "Rapports Spéciaux": "special",
